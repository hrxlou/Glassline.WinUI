...
| AppleReferenceLab skeleton | **Done for M0 buildable-probe task** | SwiftUI/AppKit probe tests + release build pass on macOS 26 CI; 54 of 72 required captures taken on macOS 26.5.2 and verified at a measured 2.0000 px/pt with filenames matching their `capture_id`; 18 `increase-contrast` captures outstanding |
